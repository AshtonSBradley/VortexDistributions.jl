...
# ╔═╡ d8851f68-0cd8-4711-9949-3b73501362da
using VortexDistributions, JLD2, GLMakie, Interpolations, NearestNeighbors, LinearAlgebra, Distances

# ╔═╡ 5c7252db-d246-4e2b-b675-6f250d00e44a
include("../util.jl")

# ╔═╡ fa467ecf-19c5-4baf-80d9-dd0f7bdd12c1
...
# ╔═╡ fe4eec01-2312-410a-9af2-4770d0d76a83
psi = psi_tubes2;

# ╔═╡ 5953f45f-5979-475a-8888-c6d24a191130
plot_iso(psi, X)

# ╔═╡ 13de0ee5-3c60-4d5b-bc90-982a7e10cec0
interp_depth = 10;

# ╔═╡ f7185321-14a6-401d-b53b-66dfa361e02a
Δx = X[1][2]-X[1][1]

# ╔═╡ 9f6e285d-3bf2-444e-a28a-70c076eb66ea
rtol = Δx; # Largest distance between two points

# ╔═╡ 1c3645ef-ca74-479d-bd1f-8b1b0691df3d
@time fils = uniqueVortices(rtol, psi, X, interp_depth)

# ╔═╡ d0753045-91a1-4c38-acef-8d8599db2ca2
num_vorts = length(fils)
...
[[VortexDistributions]]
deps = ["FFTW", "FileIO", "Interpolations", "JLD2", "LightGraphs", "LinearAlgebra", "Parameters", "Plots", "ProgressMeter", "SimpleWeightedGraphs", "SparseArrays", "SpecialFunctions", "Test", "ToeplitzMatrices"]
git-tree-sha1 = "fe3785166e912ba6715949d3f485aae558e24710"
